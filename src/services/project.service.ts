...
export const getProjectById = async (id: string): Promise<Project> => {
  const response = await api.get<{ success: boolean; data: Project }>(`/project/${id}`);
  return response.data.data;
};

export const updateProject = async (id: string, payload: any): Promise<Project> => {
  const response = await api.put<{ success: boolean; data: Project }>(`/project/${id}`, payload);
  return response.data.data;
};
...
export const getProjectStats = async (): Promise<{
  ...
  const response = await api.get<{ success: boolean; data: any }>('/project/stats');
  return response.data.data;
};
