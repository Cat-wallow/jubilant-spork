...
export default function ResetPasswordPage() {
	...
	return (
		<div className="flex min-h-screen w-full items-center justify-center bg-card px-4 py-8 dark:bg-navy-900">
			<div className="flex w-full max-w-[450px] flex-col items-center justify-center gap-[30px] rounded-[20px] bg-card px-8 py-12 shadow-[0_4px_8.3px_0_rgba(0,0,0,0.25)] dark:bg-navy-800 dark:shadow-[0_4px_8.3px_0_rgba(0,0,0,0.5)] sm:px-[50px] sm:py-[50px]">
				{/* Header */}
				<div className="flex flex-col items-center justify-center gap-2">
					<h1 className="font-dm text-xl font-bold leading-[56px] tracking-[-0.48px] text-navy-700 dark:text-white">
						Reset Kata Sandi
					</h1>
					<p className="text-center font-dm text-sm leading-[150%] tracking-[-0.32px] text-gray-700 dark:text-gray-400">
				...
				>
					...
					<div className="relative w-full">
						...
						<input
							...
							placeholder="********"
							className="h-[50px] w-full rounded-2xl border border-gray-300 px-6 font-dm text-sm leading-[100%] tracking-[-0.28px] text-gray-700 placeholder:text-gray-500 focus:border-brand-500 focus:outline-none dark:border-white/30 dark:bg-navy-900 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-brand-400"
							required
