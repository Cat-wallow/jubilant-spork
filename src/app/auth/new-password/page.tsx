...
export default function NewPasswordPage() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-white px-4 py-8 dark:bg-navy-900">
      <div className="flex w-full max-w-[510px] flex-col items-center justify-center gap-[30px] rounded-[20px] bg-white px-6 py-12 shadow-[0_4px_8.3px_0_rgba(0,0,0,0.25)] dark:bg-navy-800 dark:shadow-[0_4px_8.3px_0_rgba(0,0,0,0.5)] sm:px-[50px] sm:py-[50px]">
        {/* Lock Icon */}
        <svg
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          <h1 className="font-dm text-2xl font-bold leading-[56px] tracking-[-0.48px] text-navy-700 dark:text-white">
            Buat kata sandi baru
          </h1>
          <p className="text-center font-dm text-base font-normal leading-[150%] tracking-[-0.32px] text-gray-700 dark:text-gray-400">
          ...
          <div className="relative w-full">
            ...
            <div className="relative">
              <input
                ...
                className="h-[50px] w-full rounded-2xl border border-gray-300 px-6 pr-12 font-dm text-sm font-normal leading-[100%] tracking-[-0.28px] text-gray-700 placeholder:text-gray-500 focus:border-brand-500 focus:outline-none dark:border-white/30 dark:bg-navy-900 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-brand-400"
                minLength={8}
                required
              />
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-600 hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-400"
              >
                {showNewPassword ? (
