    ...
    <div className="flex flex-col gap-[30px]">
      ...
      <Card className="flex h-12 items-center justify-between self-stretch rounded-[20px] bg-white px-[30px]">
        ...
        <div className="flex items-center justify-end gap-5">
          <Button variant="outline" className="h-12 gap-1 rounded-[10px] border border-[#CAC4D0] bg-[#F9FAFB] px-3">
            ...
            <div className="flex items-center gap-5 self-stretch">
              <div className="flex flex-1 flex-col justify-center gap-5">
                <div className="flex items-center justify-between self-stretch">
                  <span className="font-inter text-sm font-normal text-[#6E7184]">Progress</span>
                  <span className="font-inter text-xs font-normal text-[#9C9EAA]">{project.progress}%</span>
                </div>
                <div className="flex h-[10px] flex-col items-start self-stretch overflow-hidden">
                  ...
                  <div
                    ...
                    style={{ width: `${project.progress}%`, marginTop: '-10px' }}
                  ></div>
                </div>
              </div>
              <Button variant="outline" className="gap-1 rounded-[5px] border border-[#CAC4D0] bg-white px-3 py-[6px]">
                <Eye className="h-6 w-6 text-[#404040]" />
                <span className="text-sm font-medium leading-5 tracking-[0.1px] text-[#49454F]">View</span>
              </Button>
            </div>
          </Card>
        ))}
