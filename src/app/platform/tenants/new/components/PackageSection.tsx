        ...
        <div className="flex gap-5">
          <div className="flex flex-1 flex-col">
            ...
            <input
              ...
              className="h-[53px] rounded-lg bg-gray-100 px-3 font-public-sans text-sm leading-[22px] text-navy-700 placeholder-gray-400 outline-none dark:bg-navy-900 dark:text-white"
            />
          </div>
