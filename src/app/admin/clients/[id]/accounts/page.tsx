  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>/</span>
        <Link href={`/admin/clients/${id}`} className="hover:text-primary">{client?.name || 'Detail Client'}</Link>
        <span>/</span>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Kelola Akun</h1>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-4">
            <p className="text-sm text-muted-foreground">
              Showing {((currentPage - 1) * pageSize) + 1}-{Math.min(currentPage * pageSize, accounts.length)} of {accounts.length} akun
            </p>
