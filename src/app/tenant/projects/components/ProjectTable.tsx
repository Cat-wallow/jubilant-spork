...
export default function ProjectTable({
	...
	return (
		<div className="flex flex-col gap-[50px]">
			{/* Filters */}
			<div className="flex items-center gap-5 self-stretch rounded-[10px] bg-background p-2.5">
				<div className="flex h-[54px] items-center rounded-[10px] border  bg-card px-[5px]">
					<Select value="20">
				...
				<div className="flex flex-1 items-center gap-[15px] rounded-[10px] border  bg-card px-5 py-0">
					<Search className="h-5 w-5 text-primary" strokeWidth={3} />
					<Input
						placeholder="Cari Nama Project atau Nama Klien"
						value={searchQuery}
						onChange={(e) => setSearchQuery(e.target.value)}
						className="h-[54px] border-0 bg-transparent font-dm text-base leading-5 tracking-[-0.32px] placeholder:text-muted-foreground focus-visible:ring-0"
					/>
				</div>
				...
				<div className="flex items-center gap-2.5">
					<div className="h-[54px]">
						<Select value={statusFilter} onValueChange={setStatusFilter}>
							<SelectTrigger className="h-full rounded-[10px]  bg-card px-[5px]">
					...
					<Button
						variant="outline"
						className="h-[54px] rounded-[10px]  bg-muted px-[5px]"
					>
						<Filter className="mr-1 h-[18px] w-[18px] text-primary" />
					...
					<Button
						variant="outline"
						className="h-[54px] w-[54px] rounded-[10px] bg-background p-0"
					>
			...
			<div className="flex flex-col gap-2.5">
							...
							<TableRow key={project.id} className="border-0">
								<TableCell className="w-[120px]">
									<div className="flex items-center gap-2.5">
										...
										<div className="flex flex-col">
											...
											<span className="text-sm leading-[19.6px] text-primary">
												{project.code}
											</span>
										</div>
									</div>
								...
								<TableCell className="w-[120px]">
									<div className="inline-flex items-center justify-center rounded-[6.25px] border border-[#C2C5CC] bg-[#EEEFF1] px-[3px] py-[3px]">
										<span className="font-inter text-[10.7px] text-[#7C7D8C]">
											{project.period}
										</span>
									</div>
								</TableCell>
								<TableCell className="w-[120px]">
									<div className="flex flex-wrap gap-1">
										{project.modules.map((module, idx) => (
											<div
												key={idx}
												className="inline-flex items-center justify-center rounded-[6.25px] border border-[rgba(145,158,171,0.2)] bg-background px-2.5 py-[5px]"
											>
				...
				<div className="flex items-center justify-between self-stretch">
					<span className="font-geist text-sm leading-[150%] tracking-[0.07px] text-[#737373]">
