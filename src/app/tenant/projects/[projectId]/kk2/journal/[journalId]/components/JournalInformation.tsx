		...
		<Card className="flex flex-1 flex-col items-start gap-5 self-stretch rounded-[14px] border-[0.8px] border-[#E2E8F0] shadow-[0_1px_3px_0_rgba(0,0,0,0.10),_0_1px_2px_-1px_rgba(0,0,0,0.10)]">
			<CardHeader className="flex items-center self-stretch border-b-[0.8px] border-[#E2E8F0]">
				<CardTitle className="flex items-center gap-2">
					...
					<span className="text-base leading-4 ">Journal Information</span>
				</CardTitle>
			</CardHeader>
				...
				<div className="flex flex-1 flex-col items-start gap-5">
					<div className="flex items-center gap-3 self-stretch">
						...
						<div className="flex flex-col items-start">
							<div className="text-sm leading-5 text-[#62748E]">
								Journal Number
							</div>
							<div className="font-mono text-base font-bold leading-6 ">
								{data.number}
							</div>
						</div>
					</div>
					...
					<div className="flex items-center gap-3 self-stretch">
						...
						<div className="flex flex-col items-start">
							...
							<div className="text-base font-bold leading-6 ">{data.date}</div>
						</div>
					</div>
				...
				<div className="flex flex-1 flex-col items-start gap-5">
					<div className="flex items-center gap-3 self-stretch">
						...
						<div className="flex flex-col items-start gap-[1.613px]">
							<div className="text-sm leading-5 text-[#62748E]">Status</div>
							<Badge className="inline-flex items-center gap-2 rounded-lg border-[0.8px] border-[#A4F4CF] bg-transparent px-2 py-1">
								...
								<span className="text-xs leading-4 text-[#007A55]">Posted</span>
							</Badge>
						</div>
					</div>
					...
					<div className="flex items-center gap-3 self-stretch">
						...
						<div className="flex flex-col items-start">
							<div className="text-sm leading-5 text-[#62748E]">Created By</div>
					...
					<div className="flex items-center gap-3 self-stretch">
						...
						<div className="flex flex-col items-start">
							<div className="text-sm leading-5 text-[#62748E]">Reference</div>
							<div className="text-base leading-6 ">{data.reference}</div>
						</div>
					</div>
				</div>
			</CardContent>
