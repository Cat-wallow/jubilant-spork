      ...
      <div className="flex items-center justify-center gap-2.5 self-stretch">
        <div className="flex flex-1 flex-col items-start gap-[5px]">
          ...
          <div className="flex flex-col items-start self-stretch">
            <div className="self-stretch text-[34px] font-bold leading-[42px] tracking-[-0.68px] text-[#0B1437]">
              Tambah Jurnal Manual
            </div>
            <div className="text-sm font-normal leading-5 tracking-[0.25px] text-[#64748B]">
              Buat voucher jurnal manual untuk adjustment dan koreksi - Project PRJ-2024-001
            </div>
          </div>
        </div>
      </div>
