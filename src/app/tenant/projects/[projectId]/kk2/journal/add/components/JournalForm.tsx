      ...
      <Card className="flex flex-col items-start gap-[21px] self-stretch rounded-[10.5px] border-[0.8px] border-[rgba(0,0,0,0.15)]">
        <CardHeader className="flex w-[1010.6px] flex-col items-start justify-end gap-[5.25px]">
          <CardTitle className="flex h-[18px] w-[969px] items-start gap-[7px]">
            <FileEdit className="h-[18px] w-[18px] text-[#1E293B]" />
            <span className="text-[15.75px] font-medium leading-[15.75px] tracking-[-0.394px] text-[#1E293B]">
              Informasi Voucher
            </span>
          </CardTitle>
          <CardDescription className="flex h-5 items-center text-xs font-normal leading-[19.6px] text-[#64748B]">
        ...
        <CardContent className="flex flex-col items-start gap-[14px] self-stretch">
          ...
          <div className="flex items-start justify-end gap-[14px] self-stretch">
            <div className="flex w-[314px] flex-col items-start gap-[7px]">
              <Label className="flex h-[12.25px] items-center gap-[7px] self-stretch text-xs font-medium leading-[12.25px] text-[#1E293B]">
                Tipe Voucher *
              </Label>
              <Select value={voucherType} onValueChange={setVoucherType}>
                ...
                <SelectContent>
                  <SelectItem value="MJV">MJV - Manual Journal Voucher</SelectItem>
                </SelectContent>
              </Select>
            </div>

            <div className="flex w-[314px] flex-col items-start gap-[7px]">
              <Label className="text-xs font-medium leading-[12.25px] text-[#1E293B]">
                Tanggal Voucher *
              </Label>
              <Input
                type="date"
          ...
          <div className="flex flex-col items-start gap-[7px] self-stretch">
            ...
            <Textarea
              ...
              className="h-14 self-stretch rounded-[5.25px] border-[0.8px] border-[rgba(0,0,0,0.08)] text-xs font-normal leading-[17.5px] text-[#64748B]"
            />
          </div>
          ...
          <div className="flex items-center gap-[7px] self-stretch">
            ...
            <Label
              htmlFor="adjustment"
              className="flex h-[17.5px] w-[212.6px] items-center gap-[7px] text-xs font-medium leading-[17.5px] text-[#1E293B]"
            >
