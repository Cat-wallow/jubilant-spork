...
export function BalanceCheck() {
  ...
  return (
    <Card className="flex flex-col items-start gap-[26.25px] self-stretch rounded-[10.5px] border-[0.8px] border-[rgba(0,0,0,0.15)]">
      <CardTitle className="flex w-[452px] items-center p-6 pb-0 text-base font-medium leading-[24.5px] tracking-[-0.394px] text-[#1E293B]">
        Balance Check
      </CardTitle>
        ...
        <div className="grid h-[42px] grid-cols-2 gap-[14px] self-stretch">
          <div className="flex flex-col items-start self-stretch">
            <div className="flex items-start self-stretch">
              <span className="flex-1 text-center text-xs font-normal leading-[17.5px] text-[#64748B]">
                Total Debit
              </span>
            </div>
            <div className="flex items-start self-stretch">
              <span className="flex-1 text-center text-[17.5px] font-bold leading-[24.5px] text-[#1E293B]">
