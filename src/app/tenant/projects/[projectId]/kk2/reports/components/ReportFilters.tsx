				...
				<div className="flex items-center justify-between p-6">
					<div>
						...
						<p className=" text-xs leading-4 tracking-wide text-primary">
							Daftar jurnal per akun dengan kemampuan drill-down ke voucher
							detail
						</p>
					</div>
			...
			<div className="flex flex-wrap items-center gap-4">
				...
				<div className="relative flex-1">
					...
					<Input
						...
						className="h-[54px] rounded-lg  pl-10 font-dm text-base text-muted-foreground"
					/>
				</div>

				<Button variant="outline" className="h-[54px] gap-2 rounded-lg  px-4">
					Rentang Waktu
