            ...
            <Card className="border border-black/10 shadow-sm">
              <CardContent className="flex items-center justify-between p-4">
                <div className="space-y-1">
                  ...
                  <p className="font-arial text-lg font-bold leading-7 text-[#00A63E]">
            ...
            <Card className="border border-black/10 shadow-sm">
              <CardContent className="flex items-center justify-between p-4">
                <div className="space-y-1">
                  ...
                  <p className="font-arial text-lg font-bold leading-7 text-[#E7000B]">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              {data.sections.operating.items.map((item, idx) => (
                ...
                >
                  ...
                  <span
                    className={`font-arial text-base font-normal leading-6 ${
            ...
            <div className="border-t-2 border-[#D1D5DC] pt-4">
              <div className="flex items-center justify-between">
                <span className="font-arial text-lg font-bold leading-7 text-[#0A0A0A]">
                  Total Arus Kas dari Aktivitas Operasi
                </span>
                <span className="font-arial text-lg font-bold leading-7 text-[#00A63E]">
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`font-arial text-lg font-bold leading-7 ${
                    data.sections.investing.total < 0 ? 'text-[#E7000B]' : 'text-[#00A63E]'
                  }`}
                >
        ...
        <Card className="border-r border-b border-l-4 border-t border-[#00C950]">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between rounded py-2">
              ...
              <span className="font-arial text-base font-bold leading-6 text-[#00A63E]">
                {formatCurrency(data.summary.operatingCash)}
              </span>
            </div>
            <div className="flex items-center justify-between rounded py-2">
              ...
              <span
                className={`font-arial text-base font-bold leading-6 ${
                  data.summary.investingCash < 0 ? 'text-[#E7000B]' : 'text-[#00A63E]'
                }`}
              >
            ...
            <div className="space-y-2">
              ...
              <div className="border-t-2 border-[#D1D5DC] pt-4">
                <div className="flex items-center justify-between py-2">
                  <span className="font-arial text-xl font-bold leading-7 text-[#0A0A0A]">
                    Kas dan setara kas akhir periode
                  </span>
                  <span className="font-arial text-xl font-bold leading-7 text-[#00A63E]">
        ...
        <Card className="border border-black/10">
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="space-y-2">
                <h4 className="font-arial text-base font-bold leading-6 text-[#193CB8]">
                  Aktivitas Operasi
                </h4>
              ...
              <div className="space-y-2">
                <h4 className="font-arial text-base font-bold leading-6 text-[#6E11B0]">
                  Aktivitas Investasi
                </h4>
                <p className="font-arial text-sm font-normal leading-5 text-[#9810FA]">
                  {data.analysis.investingDescription}
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-arial text-base font-bold leading-6 text-[#9F2D00]">
                  Aktivitas Pendanaan
                </h4>
