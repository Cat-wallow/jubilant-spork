...
import { Plus, Calculator, Search, Filter, MoreHorizontal, Eye, ExternalLink } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-b border-[rgba(0,0,0,0.10)]">
              <TableHead className="font-arial text-sm font-normal text-[#0A0A0A]">Pasal</TableHead>
              <TableHead className="font-arial text-sm font-normal text-[#0A0A0A]">No Bukti Potong</TableHead>
              <TableHead className="font-arial text-sm font-normal text-[#0A0A0A]">Tanggal Bukti</TableHead>
              <TableHead className="text-right font-arial text-sm font-normal text-[#0A0A0A]">Nilai Objek</TableHead>
              <TableHead className="text-right font-arial text-sm font-normal text-[#0A0A0A]">DPP</TableHead>
              <TableHead className="font-arial text-sm font-normal text-[#0A0A0A]">Tarif</TableHead>
              <TableHead className="text-right font-arial text-sm font-normal text-[#0A0A0A]">PPh</TableHead>
              <TableHead className="font-arial text-sm font-normal text-[#0A0A0A]">Masa</TableHead>
              <TableHead className="font-arial text-sm font-normal text-[#0A0A0A]">Tgl Setor</TableHead>
          ...
          <TableBody>
            {entriesData.map((entry, index) => (
              <TableRow key={index} className="border-b border-[rgba(0,0,0,0.10)]">
                ...
                <TableCell className="font-consolas text-sm text-[#0A0A0A]">{entry.noBuktiPotong}</TableCell>
                <TableCell className="font-arial text-sm text-[#0A0A0A]">{entry.tanggalBukti}</TableCell>
                <TableCell className="text-right font-arial text-sm text-[#0A0A0A]">{entry.nilaiObjek}</TableCell>
                <TableCell className="text-right font-arial text-sm text-[#0A0A0A]">{entry.dpp}</TableCell>
                <TableCell className="font-arial text-sm text-[#0A0A0A]">{entry.tarif}</TableCell>
                <TableCell className="text-right font-arial text-sm text-[#0A0A0A]">{entry.pph}</TableCell>
                <TableCell className="font-arial text-sm text-[#0A0A0A]">{entry.masa}</TableCell>
                <TableCell className="font-arial text-sm text-[#0A0A0A]">{entry.tglSetor}</TableCell>
                <TableCell>
                  <Badge
                    className={`rounded-lg border px-2 py-0.5 font-arial text-xs font-normal ${
                      entry.status === 'Valid'
                        ? 'border-[#B9F8CF] bg-[#DCFCE7] text-[#016630]'
                        : 'border-[#BEDBFF] bg-[#DBEAFE] text-[#193CB8]'
                    }`}
                  >
                    {entry.status}
                  </Badge>
