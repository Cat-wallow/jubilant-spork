  ...
  return (
    <Card className="border-[0.8px] border-black/10 bg-white">
      <CardContent className="space-y-[42px] p-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-3">
              <span className="font-['Arial'] text-base leading-6 text-[#0A0A0A]">
                ...
                <Badge
                  ...
                  className={
                    badge.variant === 'dark'
                      ...
                      : 'rounded-lg border-transparent bg-[#ECEEF2] px-2 py-0.5 text-[#030213]'
                  }
                >
                  <span className="font-['Arial'] text-xs leading-4">{badge.label}</span>
                </Badge>
              ))}
            </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-b-[0.8px] border-black/10">
              <TableHead className="font-['Arial'] text-xs leading-4 text-[#0A0A0A]">
                Kode Akun
              </TableHead>
              <TableHead className="font-['Arial'] text-xs leading-4 text-[#0A0A0A]">
                Nama Akun
              </TableHead>
              <TableHead className="text-right font-['Arial'] text-xs leading-4 text-[#0A0A0A]">
                Debit
              </TableHead>
              <TableHead className="text-right font-['Arial'] text-xs leading-4 text-[#0A0A0A]">
                Kredit
              ...
              <TableRow
                ...
                className={
                  entry.accountName === 'Total'
                    ...
                    : 'border-b-[0.8px] border-black/10'
                }
              >
                <TableCell className="font-['Consolas'] text-xs leading-4 text-[#0A0A0A]">
                  {entry.accountCode}
                </TableCell>
