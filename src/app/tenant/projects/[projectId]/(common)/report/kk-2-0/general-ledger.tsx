            ...
            <div className="flex min-h-[76px] items-center justify-between self-stretch rounded-[10px] border-[0.8px] border-[rgba(0,0,0,0.1)] px-4">
              <div className="flex items-center gap-3">
                ...
                >
                  {expandedAccounts.includes(account.id) ? (
                    <ChevronDown className="h-4 w-4 text-[#0A0A0A]" strokeWidth={1.33} />
                  ) : (
                    <ChevronRight className="h-4 w-4 text-[#0A0A0A]" strokeWidth={1.33} />
                  )}
                </Button>
                <div className="flex flex-col">
              ...
              <div className="flex items-center gap-8">
                <div className="flex flex-col items-end">
                  ...
                  <div className="font-arial text-xs leading-4 text-[#717182]">Total Debit</div>
                </div>
                <div className="flex flex-col items-end">
                  <div className="font-arial text-sm leading-5 text-[#0A0A0A]">
                    {account.totalCredit}
                  </div>
                  <div className="font-arial text-xs leading-4 text-[#717182]">Total Credit</div>
                </div>
                <div className="flex flex-col items-end">
                  <div className="font-arial text-base leading-6 text-[#0A0A0A]">
                    {account.balance}
                  </div>
                  <div className="font-arial text-xs leading-4 text-[#717182]">Balance</div>
                </div>
              </div>
            </div>

            {expandedAccounts.includes(account.id) && account.transactions.length > 0 && (
              <div className="mt-2.5 flex flex-col gap-2.5 rounded-[10px] shadow-[0_2px_2px_0_rgba(0,0,0,0.15)]">
                <div className="flex items-center justify-between border-b-[0.8px] border-[rgba(0,0,0,0.1)] p-4">
                  <div className="font-arial text-sm leading-5 text-[#0A0A0A]">Date</div>
                  <div className="font-arial text-sm leading-5 text-[#0A0A0A]">Type</div>
                  <div className="font-arial text-sm leading-5 text-[#0A0A0A]">Voucher</div>
                  <div className="font-arial text-sm leading-5 text-[#0A0A0A]">Narration</div>
