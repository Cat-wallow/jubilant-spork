...
import { Download, Filter, MoreHorizontal, Search, ChevronDown } from "lucide-react";
...
export function InvoiceTable() {
  ...
  return (
    <div className="flex flex-col items-start gap-5 self-stretch rounded-[20px] border border-[rgba(145,158,171,0.20)] p-6">
      {/* Header */}
      ...
      <div className="flex items-center gap-5 self-stretch rounded-[10px]">
        ...
        <div className="flex h-[54px] items-center gap-2.5">
          ...
          <Button variant="ghost" className="h-[54px] w-[54px] rounded-[10px] p-2">
      ...
      <div className="flex flex-col items-start gap-2.5 self-stretch">
        ...
        {invoiceData.map((item, index) => (
          <div key={index} className="flex items-center justify-between self-stretch">
            <div className="flex w-[120px] items-center gap-2.5">
              <Checkbox
            ...
            <div className="flex w-[120px] items-start content-start flex-wrap">
              <div className="flex items-center justify-center gap-2.5 rounded-[5px] border border-[rgba(145,158,171,0.20)] px-2 py-1">
                <span className="font-inter text-xs font-normal text-[#404040]">{item.termin}</span>
              </div>
            </div>
            <span className="w-[120px] font-dm text-sm font-bold leading-6 tracking-[-0.28px] text-[#2B3674]">
              {item.total}
