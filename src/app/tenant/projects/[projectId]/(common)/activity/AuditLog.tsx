    ...
    <div className="flex items-start gap-[5px] self-stretch">
      ...
      <div className="flex flex-col items-start justify-center gap-2.5">
        {auditLogData.map((item, index) => (
          <div key={index} className="flex w-[227px] flex-col items-end justify-center gap-2.5">
            <span className="self-stretch font-roboto text-xs leading-4 tracking-[0.4px] text-[#2B3674]">
              {item.time}
            </span>
            <div className="flex flex-col items-end self-stretch">
              <div className="flex items-center gap-[5px] self-stretch">
                ...
                <div className="flex w-[183px] items-center">
                  <span className="font-roboto text-sm font-normal leading-5 tracking-[0.25px] text-[#2B3674]">
                    {item.user}
                  </span>
                  <span className="font-roboto text-xs font-medium leading-4 tracking-[0.4px] text-[#2B3674]">
                    {item.action}
                  </span>
                </div>
              </div>
              <span className="w-[202px] font-roboto text-xs leading-4 tracking-[0.4px] text-[#2B3674]">
                {item.reference}
              </span>
            </div>
          </div>
