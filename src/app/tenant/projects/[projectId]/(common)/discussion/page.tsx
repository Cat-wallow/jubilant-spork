        ...
        <div className="flex items-center justify-between self-stretch">
          <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <span className="font-inter text-[9px] font-normal">Diskusi Saya</span>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <span className="font-inter text-[10px] font-normal">Dipinned</span>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <span className="font-inter text-[10px] font-normal">Belum Dibaca (1)</span>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <span className="font-inter text-center text-[10px] font-normal">Tags</span>
            </Button>
          </div>
