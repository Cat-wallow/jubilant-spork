      ...
      <div className="flex w-full flex-col gap-[10px]">
        <div className="flex w-full gap-[20px]">
          ...
          <div className="flex flex-1 flex-col gap-[7px]">
            <Label className="text-sm font-medium text-[#404040] font-dm">
              Transaction Number
            </Label>
            <div className="relative">
              <Input
                placeholder="TRX-2302-302-"
                className="bg-[rgba(145,158,171,0.08)] border-none h-[45px] rounded-[8px] text-[#404040]"
              />
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-col gap-[7px]">
            ...
            <div className="relative">
               <Input
                ...
                className="bg-[rgba(145,158,171,0.08)] border-none h-[45px] rounded-[8px] text-[#404040]"
              />
              <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#404040] opacity-50" />
            </div>
          </div>
      ...
      <div className="flex flex-col gap-[30px] w-full">
        ...
        <div className="flex gap-[30px] w-full">
          <div className="flex flex-1 items-center justify-between p-[20px] rounded-[20px] border border-[rgba(145,158,171,0.2)] bg-white">
            <span className="text-[22px] font-medium text-[#404040] font-roboto leading-7">
      ...
      <div className="flex flex-col gap-[10px] w-full">
        <div className="flex items-center justify-between w-full">
          ...
          >
            ...
            <span className="text-[14px] font-medium font-roboto tracking-[0.1px]">Tambah Dokumen</span>
          </Button>
        </div>
