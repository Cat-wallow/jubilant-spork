...
import { Plus, Upload, Search, UserCheck, UserX } from 'lucide-react';
...
// This will only be rendered if the RBAC check passes.
function UsersPageContent() {
  ...
  // This hook will now only run if the user has permission.
...
// The main export is now a simple wrapper that handles the RBAC check.
export default function TenantUsersPage() {
  return (
    <RBAC
      requiredPermission="tenant:user_manage"
