const Radio = (props: {
  ...
  return (
    <input
      ...
      type="radio"
      checked={checked}
      className={`before:contet[""] relative h-5 w-5 cursor-pointer appearance-none rounded-full border !border-gray-200 transition-all duration-200 before:absolute before:left-[50%] before:top-[3px] before:h-3 before:w-3 before:translate-x-[-50%] before:rounded-full before:transition-all before:duration-200 dark:!border-gray-800 ${
        color === 'red'
