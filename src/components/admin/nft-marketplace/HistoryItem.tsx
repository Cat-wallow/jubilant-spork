  ...
  return (
    <Card extra={'mt-3 !z-5 overflow-hidden'}>
      ...
      <div className="flex items-center justify-between rounded-t-3xl p-3">
        ...
        <button className="linear rounded-[20px] bg-lightPrimary px-4 py-2 text-base font-medium text-brand-500 transition duration-200 hover:bg-gray-100 active:bg-gray-200 dark:bg-card/5 dark:text-white dark:hover:bg-card/10 dark:active:bg-card/20">
          See all
        </button>
      </div>
      ...
      {HistoryData.map((data, index) => (
        <div
          key={index}
          className="flex h-full w-full items-start justify-between bg-card px-3 py-[20px] hover:shadow-2xl dark:!bg-navy-800 dark:shadow-none dark:hover:!bg-navy-700"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-1 text-sm text-gray-600"> {data.owner} </p>
            </div>
          </div>
          ...
          <div className="mt-1 flex items-center justify-center text-navy-700 dark:text-white">
            ...
            <div className="ml-2 flex items-center text-sm text-gray-600 dark:text-white">
              <p>{data.time}</p>
